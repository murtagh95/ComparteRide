...
class MembershipModelSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'remaining_invitations', 'invited_by',
...
class AddMemberSerializer(serializers.Serializer):
    """ Add member serializer.
     ...
     Handle the addition of a new member to a circle. Circle object
     must be provided in the context. """
    ...
    def validate_user(self, data):
        ...
        if q.exists():
            raise serializers.ValidationError('User is already member of '
                                              'this circle')
        return data
    ...
    def validate(self, attrs):
        ...
        circle = self.context['circle']
        if circle.is_limited and \
            circle.members.count() >= circle.members_limit:
            raise serializers.ValidationError('Circle has reached its member'
                                              'limit.')
        return attrs
    ...
    def create(self, validated_data):
        ...
        member = Membership.objects.create(
            ...
            circle=circle,
            invited_by=invitation.issue_by
        )
        ...
        # Update issuer data
        issuer = Membership.objects.get(user=invitation.issue_by,
                                        circle=circle)
